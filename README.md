...
9.Assign the learning rate For ‘N ‘ iterations ,do the following: v(i) = w(i)*x(i)

    W (i+i)= W(i) + learning_rate*(y(i)-t(i))*x(i)
10.Plot the error for each iteration Print the accuracy

 ## PROGRAM:
 ```
Developed by:M.Hari krishna..
Registration no:212221230059.
 ```
 ```
 import numpy as np
import pandas as pd
...
## Result :
Thus,the perceptron for classification using Python is executed successfully.
